...
export function SearchBox() {
  ...
  return (
    <div className="relative w-full">
      <div className="relative flex items-center w-full bg-primary rounded-lg shadow-md p-0.5">
        <div className="bg-white relative flex items-center w-full p-1 rounded-lg">
              ...
              <div className="absolute left-0 top-full mt-2 w-40 bg-white shadow-md rounded-md z-10">
                {filters.map((filter, index) => (
                  <button
                    ...
                    className="w-full px-4 py-2 text-left text-sm text-black hover:secondary focus:outline-none"
                  >
                    {filter}
                  </button>
                ))}
          ...
          <button 
            className="flex items-center justify-center mr-1 p-2 bg-primary text-white rounded-md hover:bg-primary"
